				...
				<table class="form-table">
					<tbody>
						...
						<tr>
							...
							<td>
								<fieldset>
									<label><input type="checkbox" name="disable_weekdays:sunday" class="option" disabled /> <?php echo esc_html( __( 'Sunday', 'contact-form-7' ) ); ?></label>
									<label><input type="checkbox" name="disable_weekdays:monday" class="option"/ disabled > <?php echo esc_html( __( 'Monday', 'contact-form-7' ) ); ?></label>
									<label><input type="checkbox" name="disable_weekdays:tuesday" class="option" disabled /> <?php echo esc_html( __( 'Tuesday', 'contact-form-7' ) ); ?></label>
									<label><input type="checkbox" name="disable_weekdays:wednesday" class="option" disabled /> <?php echo esc_html( __( 'Wednesday', 'contact-form-7' ) ); ?></label>
									<label><input type="checkbox" name="disable_weekdays:thursday" class="option" disabled /> <?php echo esc_html( __( 'Thursday', 'contact-form-7' ) ); ?></label>
									<label><input type="checkbox" name="disable_weekdays:friday" class="option" disabled /> <?php echo esc_html( __( 'Friday', 'contact-form-7' ) ); ?></label>
									<label><input type="checkbox" name="disable_weekdays:saturday" class="option" disabled /> <?php echo esc_html( __( 'Saturday', 'contact-form-7' ) ); ?></label>
								</fieldset>
